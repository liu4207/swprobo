...
def generate_launch_description():
	...
	lidar_type_arg = DeclareLaunchArgument(name='lidar_type', default_value='X3', description='The type of lidar')
        lidar_launch = IncludeLaunchDescription(PythonLaunchDescriptionSource([get_package_share_directory('ydlidar_ros2_driver') + '/launch/ydlidar_launch.py']))
...
def generate_launch_description():
    ...
    slam_x3_gmapping_launch = IncludeLaunchDescription(
        ...
        condition=LaunchConfigurationNotEquals('lidar_type', 'x3')
    )
    return LaunchDescription([
        lidar_type_arg,
        lidar_launch,
