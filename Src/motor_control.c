...
void Motor_SetSpeed(uint8_t speed)
{
    ...
    pulse_value = (uint32_t)(999 * speed / 100.0);
    __HAL_TIM_SetCompare(&MOTOR_PWM_TIMER, MOTOR_PWM_CHANNEL1, pulse_value);
    __HAL_TIM_SetCompare(&MOTOR_PWM_TIMER, MOTOR_PWM_CHANNEL2, pulse_value);
}
